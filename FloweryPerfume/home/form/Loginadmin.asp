                                ...
                                <div class="modal-dialog">
                                    ...
                                    <div class="modal-content">
                                          ...
                                          <div class="modal-body">
                                                <form role="form" action="Login_process.asp" name="myForm" id="myForm" onsubmit="return validateForm()">
                                                      ...
                                                      <div class="checkbox">
                                                            <label>
                                                              <input name="conf" class="add-confirm" type="checkbox"> Đồng ý đăng nhập
                                                            </label>
                                                      </div>
